...
namespace our
{
    ...
    public:
        ...
        {
            // TODO: Complete this function
            glBindSampler(textureUnit, name); // this will bind the texture with our sampler
        }
        ...
        static void unbind(GLuint textureUnit)
        {
            ...
            // the generated sampler is in name 1
        }
        ...
        void set(GLenum parameter, GLint value) const
        {
            ...
            // it will filter the texture with the given parameter and wrapping acounrding to value
        }
