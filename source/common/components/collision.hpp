...
namespace our {
    ...
    public:
        glm::vec4 center = {0, 0, 0,1}; // Each frame, the entity should move as follows: position += linearVelocity * deltaTime 
        float radius = 0; // Each frame, the entity should rotate as follows: rotation += angularVelocity * deltaTime
